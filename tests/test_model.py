...
class ModelTestCase(unittest.TestCase):
    ...
    def test_feed_add_new(self):
        ...
        self.assertEqual(feed.current_article, article_1) # Should default to the new article
    ...
    def test_feed_get_next(self):
        ...
        self.assertEqual(feed.current_article, article_1) # Should loop around end to start
